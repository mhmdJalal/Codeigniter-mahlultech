  		...
  		<div class="container">
  			<div class="row ">
  				<div class="col s12 center-align">
  					<img class="responsive-img" src="<?= base_url('assets/img/search.png') ?>" alt="">
  				</div>
  				<div class="col s12 center-align">
  					<h3 class="light font-pompadour">Opss!! Search not found</h3>
  					<h5 class="font-pompadour">Try with any keyword</h5>
